...
async def main():
    ...
    outputs = {
        ...
        'lock_door': FakeDigitalOutput('lock_door'),
    }
    ...
    while True:
        ...
        answer = await ainput('Next command. Either "(t/h/on/off/q) Input" or "(c/q)": \n')
        try:
